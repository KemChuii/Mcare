...
function my_form()
{
    $content = '';
      ...
      $content .='<form class="submit" method="post" action="http://localhost:9000/MCare/bestil-en-tid-nu/">';
    ...
    $content .= '<p id="promotion-header-title">Er din telefon/tablet gået i stykker? Ring til os, så kommer vi ud til dig.</p>';
    
   $content .='</div>';
  
    $content .= '<div id="submitForm">';
    $content .= '<input type="submit" id="submitBtn" name="submitBtn" value="Bestil tid nu!">';
    $content .= '</div>';
